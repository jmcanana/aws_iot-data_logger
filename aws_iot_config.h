...
#define AWS_IOT_MQTT_CLIENT_ID         "ras_pi_fc2de3e3" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 	       "ras_pi_fc2de3e3" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "rootCA.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "ras_pi_fc2de3e3_cert.pem" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "ras_pi_fc2de3e3_privkey.pem" ///< Device private key filename
// =================================================
