...
int main(int argc, char **argv) {
	...
	IOT_INFO("Subscribing...");
        const char topic[] = "data_logger/ras_pi_fc2de3e3/sub";
        const char topic2[] = "data_logger/master_control/reset";
	...
	while((NETWORK_ATTEMPTING_RECONNECT == rc || NETWORK_RECONNECTED == rc || SUCCESS == rc)
		...
		rc = aws_iot_mqtt_publish(&client, topic2, strlen(topic2), &paramsQOS1);
